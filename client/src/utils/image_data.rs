...
impl From<&crate::moxnotify::types::ImageData> for ImageData {
    fn from(proto: &crate::moxnotify::types::ImageData) -> Self {
        Self {
            width: proto.width,
            height: proto.height,
            rowstride: proto.rowstride,
            has_alpha: proto.has_alpha,
            bits_per_sample: proto.bits_per_sample,
